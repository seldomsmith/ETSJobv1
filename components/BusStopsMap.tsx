  ...
  return (
    <div className="w-full h-full relative">
      ...
      >
        ...
        {viewMode === 'stranded' && (
          <>
            <Source id="stranded-jobs" type="geojson" data={`/data/stranded_jobs.geojson?v=3`}>
              <Layer 
        ...
        {/* Hover Info Tooltip */}
        {hoverInfo && (
          <div className="absolute bg-slate-900/90 text-white p-3 rounded-lg shadow-xl text-sm border border-white/10 pointer-events-none" style={{left: hoverInfo.x + 15, top: hoverInfo.y + 15, zIndex: 1000}}>
            ...
            {(hoverInfo.feature.source === 'jobs' || hoverInfo.feature.source === 'stranded-jobs') && (
              <>
                ...
                {hoverInfo.feature.properties.nearest_stop_dist !== undefined && (
                  <div className="mt-1 text-aurora-cyan font-semibold">Distance to Transit: {hoverInfo.feature.properties.nearest_stop_dist}m</div>
                )}
              </>
            )}
